...
class AttackRunner():
    ...
    def run(self):
        ...
        for sample, ground_truth in self.dataset.tolist():
            ...
            if result:
                if self.__result_status(result) == "Skipped":
                    skipped_num += 1
                    attack_results.append({"original_text": sample,
                                           "status": "Skipped",
        ...
        print("Skipped number is : ",skipped_num)
    ...
    def attack_result_to_json(self, result):
        ...
        if labels_map is not None:
            labelled_data = {
                "ground_truth_labels": self.__prediction_to_labels(original_text.attack_attrs["ground_truth"],
                                                                   labels_map),
                ...
                "final_ground_truth_labels": self.__prediction_to_labels(perturbed_text.attack_attrs["ground_truth"],
                                                                         labels_map)
            }
        ...
        with open(self.output_filename, "w") as out_file:
            ...
            out_file.write(json.dumps({
                "config": {
                    ...
                    "recipe": self.attack_args["recipe_metadata"]["recipe"],
